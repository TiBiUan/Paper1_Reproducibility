...
Cfg.Run.Realignment = false;
Cfg.Run.Descriptors = false;
Cfg.Run.StabilityNull = false;
Cfg.Run.RawSCAnalysis = false;
Cfg.Run.SurrogateSparsity = false;
Cfg.Run.FamilyOrganization = false;
Cfg.Run.BehaviorPrediction = false;
Cfg.Run.DynamicAnalysis = false;
